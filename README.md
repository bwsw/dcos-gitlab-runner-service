# dcos-gitlab-runner-service (Fork)

[![Docker Stars](https://img.shields.io/docker/stars/foxel/dcos-gitlab-runner-service.svg)](https://hub.docker.com/r/foxel/dcos-gitlab-runner-service/)
[![Docker Pulls](https://img.shields.io/docker/pulls/foxel/dcos-gitlab-runner-service.svg)](https://hub.docker.com/r/foxel/dcos-gitlab-runner-service/)
[![](https://images.microbadger.com/badges/image/foxel/dcos-gitlab-runner-service.svg)](http://microbadger.com/images/foxel/dcos-gitlab-runner-service "Get your own image badge on microbadger.com")
...
```javascript
{
  ...
  "container": {
    "type": "DOCKER",
    "docker": {
      "image": "foxel/dcos-gitlab-runner-service:latest",
      "network": "HOST",
      "forcePullImage": true,
      "privileged": true
    }
